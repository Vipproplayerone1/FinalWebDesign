...
<form action="login.php" method="post" class="relog">
    <div class="relog-form">
        <h2 class="relog-form__heading">Log in</h2>
        <p class="relog-form__title">If you do not already have an account, <a href="register.php" class="relog-form__link">REGISTER</a> here</p>
        <div class="relog-form__info">
            <div class="relog-form__gr">
                <input type="text" class="relog-form__gr-input" placeholder="User name" name="tendangnhap">
            </div>
            <div class="relog-form__gr">
                <input type="text" class="relog-form__gr-input" placeholder="Password" name="matkhau">
            </div>
        </div>
        ...
        <a href="password_forget.php" class="relog-form__btn-forget">Forgot password?</a>
