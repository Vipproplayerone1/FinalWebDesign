...
if (isset($_POST['guiemail']) && ($_POST['guiemail'])) {
    ...
    if (is_array($checkemail)) {
        $_SESSION['thongbao'] = "Your password is: " . $checkemail['matkhau'];
    } else {
        $_SESSION['thongbao'] = "This email does not exist";
    }
...
<body>
    <form action="password_forget.php" method="post" class="relog">
        <div class="relog-form">
            <h2 class="relog-form__heading">Forgot password</h2>
            ...
            <div class="relog-form__btn">
                <input class="relog-form__btn-link" type="submit" value="Login" name='guiemail'>
            </div>
