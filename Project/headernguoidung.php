...
<head>
    ...
    <meta name="description"
        content="Shop the latest fashion trends at HNSHop. Explore our collection of clothing, accessories, and more.">
                ...
                <div class="header-top">
                    <div class="header-top__gr">
                        ...
                        <form action="search.php" method="POST" class="header-top__search" role="search">
                            <input type="text" name="tukhoa" class="header-top__search-input"
                        ...
                        <div class="header-top__tools">
                            <div class="header-top__join">
                                ...
                                <div class="header-top__join-wrap">
                                    <span title="Thông tin"
                                        class="header-top__join-in"><?php echo htmlspecialchars($_SESSION['user']); ?></span>
                                    <ul class="header-top__join-menu">
                                        <li class="header-top__join-menu-items"><a class="header-top__join-out"
                                                href="info_product.php">Order</a></li>
                                        <li class="header-top__join-menu-items"><a class="header-top__join-out"
                            ...
                            <div class="header-top__cart">
                                ...
                                <span
                                    class="header-top__cart-notify-num"><?php echo isset($_SESSION['giohang']) ? count($_SESSION['giohang']) : 0; ?></span>
                                <div class="header-top__cart-notify">
                                    <span class="header-top__no-notify-text">There are no products in your shopping
                                        cart</span>
            ...
            <div class="header-bottom__gr">
                <nav>
                    <ul class="header-bottom__list">
                        <li class="header-bottom__items"><a href="index_home.php" class="header-bottom__items-link">Home
                                page</a></li>
                        <li class="header-bottom__items">
                            ...
                            <div class="header-bottom__product-list">
                                ...
                                <a class="header-bottom__product-links"
                                    href="cat.php?nhom_id=<?php echo $row_nhom['id']; ?>"><?php echo htmlspecialchars($row_nhom['tennhom']); ?></a>
                                <?php } ?>
                            </div>
                        </li>
                        <li class="header-bottom__items"><a href="index_news.php"
                                class="header-bottom__items-link">News</a></li>
                        <li class="header-bottom__items"><a href="contact.php"
                                class="header-bottom__items-link">Contact</a></li>
                    </ul>
                </nav>
