...
<div class="example">
    <div class="container">
        <div class="row">
            <h2 class="heading_admin">Product Group Management</h2>
            ...
            <button><a href="themsanpham_nhom.php" style="text-decoration: none; color: black;">Add Product Group</a></button>
        </div>
    </div>
</div>
