                    ...
                    <div class="col l-6">
                        ...
                        <div class="contact__info">
                            <div class="contact__gr">
                                <input type="text" class="contact__gr-input" name="hoten" placeholder="First and last name">
                            </div>
                            <div class="contact__gr">
                                <input type="email" class="contact__gr-input" name="email" placeholder="Email">
                            </div>
                            <div class="contact__gr">
                                <input type="text" class="contact__gr-input" name="sdt" placeholder="Phone Number">
                            </div>
                            <div class="contact__gr">
                                <textarea id="ghichu"  cols="30" rows="8" name="ghichu" class="contact__gr-input" placeholder="Content"></textarea>
                            </div>
                        </div>
                        <div class="contact__btn">
                            <button type="submit" class="contact__btn-link" name="tbOk">Send information</button>
                        </div>
                    </div>
                    <div class="col l-6">
